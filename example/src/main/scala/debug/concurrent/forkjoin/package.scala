...
package object forkjoin {
  @deprecated("use java.util.debug.concurrent.ForkJoinPool directly, instead of this alias",         "2.12.0")
  ...
  @deprecated("use java.util.debug.concurrent.ForkJoinTask directly, instead of this alias",         "2.12.0")
  ...
  @deprecated("use java.util.debug.concurrent.ForkJoinWorkerThread directly, instead of this alias", "2.12.0")
  type ForkJoinWorkerThread   = juc.ForkJoinWorkerThread
  @deprecated("use java.util.debug.concurrent.LinkedTransferQueue directly, instead of this alias",  "2.12.0")
  type LinkedTransferQueue[T] = juc.LinkedTransferQueue[T]
  @deprecated("use java.util.debug.concurrent.RecursiveAction directly, instead of this alias",      "2.12.0")
  type RecursiveAction        = juc.RecursiveAction
  @deprecated("use java.util.debug.concurrent.RecursiveTask directly, instead of this alias",        "2.12.0")
  type RecursiveTask[T]       = juc.RecursiveTask[T]

  @deprecated("use java.util.debug.concurrent.ThreadLocalRandom directly, instead of this alias",    "2.12.0")
