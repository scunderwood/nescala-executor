...
package debug.concurrent.duration
...
/**
 * <h2>Utility for working with java.util.debug.concurrent.TimeUnit durations.</h2>
 *
 * '''''This class is not meant as a general purpose representation of time, it is
 * optimized for the needs of `scala.debug.concurrent`.'''''
 *
 * <h2>Basic Usage</h2>
 *
 * <p/>
 * Examples:
 * {{{
 * import scala.debug.concurrent.duration._
 *
